...
vi.mock('leaflet', () => {
  const map = vi.fn(() => ({ setView: vi.fn().mockReturnThis(), remove: vi.fn() }));
...
vi.mock('leaflet/dist/images/marker-icon.png', () => ({ default: 'icon' }), { virtual: true });
vi.mock('leaflet/dist/images/marker-icon-2x.png', () => ({ default: 'icon2x' }), { virtual: true });
vi.mock('leaflet/dist/images/marker-shadow.png', () => ({ default: 'shadow' }), { virtual: true });
